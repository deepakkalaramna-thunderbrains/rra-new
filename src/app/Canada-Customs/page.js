        ...
        <div className="row">
            <div className="col-md-12">
                <div className="w-100 h-100 position-relative">
                    <img className="w-100 img-fluid cover" src="/images/hero-CANADA-CUSTOMS.jpg" alt="" />
                    <h1 className="w-100 m-0 text-center text-uppercase position-absolute top-50 start-50 translate-middle text-white">CANADA CUSTOMS</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="row">
                <div className="col-md-11 mx-auto pt-5">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 px-4">
                            <img className="w-100 img-fluid cover" src="/images/streamlined.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row">
                ...
                <div className="col-md-4 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">Customs Clearance</h4>
                        <p className="text-white mb-0">We facilitate the customs clearance process, ensuring your goods comply with Canadian regulations, minimizing delays, and avoiding costly penalties.</p>
                    </div>
                </div>
                <div className="col-md-4 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">Documentation</h4>
                        <p className="text-white mb-0">Our experts handle all the necessary documentation, including invoices, certificates, and permits, ensuring everything is for customs clearance.</p>
                    </div>
                </div>
                <div className="col-md-4 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">Tariff Classification</h4>
                        <p className="text-white mb-0">We help you correctly classify your products for tariff purposes, ensuring you pay the right duty and taxes.</p>
                    </div>
                </div>
            </div>
        </div>
