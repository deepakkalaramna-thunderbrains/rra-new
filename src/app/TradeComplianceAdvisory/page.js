{/* <section class="cus-hero-sec">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-11 mx-auto py-5">
                    <h2 class="mb-3 text-center text-uppercase">Trust <span class="text-orange">RRA Group</span> to be your steadfast advisor in the world of trade compliance.</h2>
                </div>
                <div class="col-md-11 mx-auto pt-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 px-5">
                            ...
                            <p>By partnering with us, you gain peace of mind and operational efficiency. Our advisory services optimize duty and tax assessments, saving money and resources.</p>
    ...
    <section class="pb-5 mb-5 cus-oragne-one-column">
        <div class="container-fluid">
            <div class="oragne-gradient p-5">
                <div class="cus-max-width mx-auto py-5">            
                    <h3 class="text-white text-uppercase text-center">We facilitate smooth cross-border operations, allowing you to focus on expanding your global reach.</h3>
                    <ul class="list-unstyled m-auto pt-4 mt-4">
                        <li class="bg-white"><h5 class="m-0">Expertise and Industry Knowledge</h5></li>
                        <li class="bg-white"><h5 class="m-0">Comprehensive compliance solutions</h5></li>
                        <li class="bg-white"><h5 class="m-0">Efficiency and Cost Effectiveness</h5></li>
                        <li class="bg-white"><h5 class="m-0">Transparency and Communication</h5></li>
                    </ul>
                </div>
            </div>
        </div>
...
export default TradeComplianceAdvisory