                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="w-100 h-100 position-relative">
                            <img className="w-100 img-fluid cover" src="/images/hero-plane-trucks-are-flying.jpg" alt="" />
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-11 mx-auto py-5">
                            <h2 className="mb-3 text-center text-uppercase">Stay Informed Every Step of the Way</h2>
                        </div>
                        <div className="col-md-11 mx-auto pt-3">
                            <div className="row align-items-center">
                                <div className="col-md-6 px-5">
                                    <ul className="list-unstyled p-0">
                                        <li className="w-100 d-flex align-items-start mb-3">
                                ...
                                <div className="col-md-6 px-5">
                                    <img className="w-100 img-fluid cover" src="/images/digital-composite-businessman-working-map.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
