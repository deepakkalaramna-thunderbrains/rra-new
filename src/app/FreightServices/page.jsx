                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="w-100 h-100 position-relative">
                            ...
                            <h1 class="w-100 m-0 text-center text-uppercase position-absolute top-50 start-50 translate-middle text-white">Freight Forwarding</h1>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-md-11 mx-auto pt-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 px-5 grid-experience">
                        ...
                        <div class="col-lg-6 my-3">
                            <div class="w-100 h-100 p-5 bg-secondary-dark">
                                ...
                                <Link href="/FreightServices2">
                                    <span className="btn btn-primary btn-outline btn mt-4">
