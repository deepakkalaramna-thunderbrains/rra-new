                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="w-100 h-100 position-relative">
                            <img className="w-100 img-fluid cover" src="/images/hero-freight-forwarding.png" alt="" />
                            <h1 className="m-0 text-center text-uppercase position-absolute top-50 start-50 translate-middle text-white">Freight Forwarding</h1>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="row align-items-center">
                                <div className="col-md-6 px-5">
                                    <h2 className="mb-3 text-uppercase">
                                        Experience Hassle-Free Global Shipping with <span className="text-orange">RRA</span>.
                                    </h2>
                                ...
                                <div className="col-md-6 px-5 grid-experience">
                                    <img className="w-100 img-fluid cover " src="/images/grid-experience.png" alt="" />
                    ...
                    <div className="row">
                        <div className="col-md-6 my-3">
                            <div className="w-100 h-100 p-5 bg-secondary-dark">
                                <h3 className="text-white text-uppercase mb-4">Freight services</h3>
                                <p className="text-white mb-4">We provide a range of transportation options, such as ground shipping, ocean freight, and air cargo. Our border-crossing experience is flawless, insuring a 100% success rate.</p>
                        ...
                        <div className="col-md-6 my-3">
                            <div className="w-100 h-100 p-5 bg-secondary-dark">
                                <h3 className="text-white text-uppercase mb-4">Shipment tracking</h3>
                                ...
                                <Link href='/ShipmentTracking'>
                                    <span type="submit" className="btn btn-primary btn-outline btn-lg mt-4">
                                        <span className="d-flex align-items-center justify-content-center">
                                            Learn More
                                            <svg className="ms-3" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                                <path d="M16.6716 10.9999L11.3076 5.63589L12.7218 4.22168L20.5 11.9999L12.7218 19.778L11.3076 18.3638L16.6716 12.9999H4.5V10.9999H16.6716Z" fill="#FE7C04" />
                        ...
                        <div className="col-md-6 my-3">
                            <div className="w-100 h-100 p-5 bg-secondary-dark">
                                <h3 className="text-white text-uppercase mb-4">NO Mini-Max Weight Limit</h3>
                                <p className="text-white mb-4">Unlimited cargo capacity, transparent pricing, and prompt deliveries. We handle shipments of all sizes with no hidden costs. Your logistics are made simple, efficient, and reliable.</p>
                                <button type="submit" className="btn btn-primary btn-outline btn-lg mt-4">
                                    <span className="d-flex align-items-center justify-content-center">
                                        Learn More
                                        <svg className="ms-3" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                            <path d="M16.6716 10.9999L11.3076 5.63589L12.7218 4.22168L20.5 11.9999L12.7218 19.778L11.3076 18.3638L16.6716 12.9999H4.5V10.9999H16.6716Z" fill="#FE7C04" />
                        ...
                        <div className="col-md-6 my-3">
                            <div className="w-100 h-100 p-5 bg-secondary-dark">
                                <h3 className="text-white text-uppercase mb-4">Trade Show Freight</h3>
                                <p className="text-white mb-4">Elevate your trade show success. RRA excels in meticulous planning, seamless coordination, and reliable transport of trade show materials, guaranteeing your exhibitions' resounding success.</p>
                                <button type="submit" className="btn btn-primary btn-outline btn-lg mt-4">
                                    <span className="d-flex align-items-center justify-content-center">
                                        Learn More
                                        <svg className="ms-3" xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
