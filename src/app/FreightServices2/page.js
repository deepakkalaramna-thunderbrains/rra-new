                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="w-100 h-100 position-relative">
                            <img class="w-100 img-fluid cover" src="images/hero-freight-services.jpg" alt="" />
                        ...
                        <div class="col-md-11 mx-auto pt-3">
                            <div class="row align-items-center">
                                <div class="col-md-6 px-5">
                                    <img class="w-100 img-fluid cover" src="images/grid-services.jpg" alt="" />
                                </div>
                                <div class="col-md-6 px-5">
                            ...
                            <section id="ground-freight-tab">
                                <div class="tab-pane-inner">
                                    ...
                                    <div class="vertical-tab-img">
                                        <img class="w-100 h-100 img-fluid cover" src="images/grid-services.jpg" alt="" />
                                    </div>
                                </div>
                            </section>
                        ...
                        <div class="col-md-6">
                            <div class="oragne-gradient p-5 h-100">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <img class="d-flex align-items-center justify-content-center h-100 img-fluid contain" src="images/icon-safety.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
