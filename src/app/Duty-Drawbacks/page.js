        ...
        <div className="row">
            <div className="col-md-12">
                <div className="w-100 h-100 position-relative">
                    <img className="w-100 img-fluid cover" src="/images/hero-DUTY-DRAWBACKS.jpg" alt="" />
                    <h1 className="w-100 m-0 text-center text-uppercase position-absolute top-50 start-50 translate-middle text-white">DUTY DRAWBACKS</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="row">
                <div className="col-md-11 mx-auto pt-5">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 px-5">
                            <img className="w-100 img-fluid cover" src="/images/supply-chain.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-md-12 my-3">
                    <h2 className="text-center text-uppercase">How Can We Help?</h2>
                </div>
                <div className="col-md-6 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">In-Depth Analysis</h4>
                        <p className="text-white mb-0">Our experts comprehensively analyze your trade operations to identify eligible duty drawbacks, ensuring you don't miss out on any potential savings.</p>
                    </div>
                </div>
                <div className="col-md-6 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">Efficient Documentation</h4>
                        <p className="text-white mb-0">We assist in the preparation and submission of all required documentation to the customs authorities, simplifying the process and minimizing delays.</p>
                    </div>
                </div>
            </div>
        </div>
