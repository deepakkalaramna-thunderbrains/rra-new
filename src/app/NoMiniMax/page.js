...
function NoMiniMax(){
        ...
        <div className="row">
            <div className="col-md-12">
                <div className="w-100 h-100 position-relative">
                    <img className="w-100 img-fluid cover" src="/images/hero-NO-MINI-MAX-WEIGHT-LIMIT.jpg" alt="" />
                    <h1 className="w-100 m-0 text-center text-uppercase position-absolute top-50 start-50 translate-middle text-white">NO MINI-MAX WEIGHT LIMIT</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="row">
                <div className="col-md-11 mx-auto pt-5">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 px-5">
                            <img className="w-100 img-fluid cover" src="/images/ship-without-conflict.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section className="pb-5 cus-oragne-two-column">
        <div className="container-fluid">
            <div className="row py-5">
                    ...
                    <div className="oragne-gradient p-5 h-100">
                        <div className="row">
                            <div className="col-md-8">
                                <h3 className="text-white text-uppercase">Stress-Free Logistics</h3>
                                <p className="m-0 text-white">Say goodbye to the hassles of finding multiple carriers for different-sized shipments. We simplify logistics by handling everything, regardless of the cargo's size.</p>
                            </div>
                            <div className="col-md-4">
                                <div className="w-100 d-flex align-items-center justify-content-center h-100">
                                    <img className="img-fluid contain" src="/images/stress-free-logistics.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-md-6">
                    <div className="oragne-gradient p-5 h-100">
                        <div className="row">
                            <div className="col-md-8">
                                <h3 className="text-white text-uppercase">Swift <br />Turnaround</h3>
                                <p className="m-0 text-white">Whether you have a small package or a massive load, we ensure swift turnaround times, ensuring your cargo reaches its destination promptly.</p>
                            </div>
                            <div className="col-md-4">
                                <div className="w-100 d-flex align-items-center justify-content-center h-100">
                                    <img className="img-fluid contain" src="/images/swift-turnaround.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
