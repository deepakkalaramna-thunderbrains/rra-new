...
<<<<<<< HEAD
  ...
  return(
    <footer className="bg-secondary-dark pt-5">
                ...
                <div className="col-md-9">
                    <div className="row">
                        ...
                        <div className="col-md-3">
                            <h6 className="mb-4">
                              Custom Brokerage
                              <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" style={{width:'20', height:'20'}} viewBox="0 0 20 20" fill="none">
                                <path d="M13.4765 9.16658L9.0065 4.69657L10.185 3.51807L16.6668 9.99992L10.185 16.4817L9.0065 15.3032L13.4765 10.8332H3.3335V9.16658H13.4765Z" fill="white"/>
                              </svg>
                            </h6>
                            <ul className="list-unstyled m-0">
                                <li>
                        ...
                        <div className="col-md-3 footer-contact-us">
                            <h6 className="mb-4">
                              Contact Us
                              <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" style={{width:'20', height:'20'}} viewBox="0 0 20 20" fill="none">
                                <path d="M13.4765 9.16658L9.0065 4.69657L10.185 3.51807L16.6668 9.99992L10.185 16.4817L9.0065 15.3032L13.4765 10.8332H3.3335V9.16658H13.4765Z" fill="white"/>
                            ...
                            <ul className="list-unstyled m-0 d-flex flex-column align-items-start">
                                <li className="mb-4">
                                    <div className="d-flex align-items-center">
                                        <svg style={{width:'30px', height:'30px'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none">
                                ...
                                <li>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <p className="ps-3 mb-0 text-white">United States</p>
                                    </div>
                                    <div className="d-flex flex-column mt-3">
                                        <p className="text-white"><a href="mailto:rra@gmail.com">rra@gmail.com</a></p>
                                        <p className="text-white mb-0">710 W Bell Rd #44, Glendale, Arkansas, United States, 85308</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled m-0">
                        ...
                        <li>
                            <a href="/ShipmentTracking">Shipment Tracking</a>
                        </li>
                        <li>
                            <a href="/NoMiniMax">No Mini-Max Weight Limit</a>
                        </li>
                ...
                <div class="col-md-3 footer-contact-us">
                    ...
                    <ul class="list-unstyled m-0 d-flex flex-column align-items-start">
                        <li class="mb-4">
                            <div class="d-flex align-items-center">
                                <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg"   viewBox="0 0 80 80" fill="none">
                                    <g clip-path="url(#clip0_215_140)">
                                    <path d="M40 80C62.0914 80 80 62.0914 80 40C80 17.9086 62.0914 0 40 0C17.9086 0 0 17.9086 0 40C0 62.0914 17.9086 80 40 80Z" fill="#F0F0F0"/>
                                    <path d="M79.9994 40.0001C79.9994 24.1416 70.7705 10.4391 57.3906 3.96912V76.0308C70.7705 69.561 79.9994 55.8585 79.9994 40.0001Z" fill="#D80027"/>
                                    <path d="M0 40.0001C0 55.8585 9.22891 69.561 22.6087 76.031V3.96912C9.22891 10.4391 0 24.1416 0 40.0001Z" fill="#D80027"/>
...
<div class="container-fluid py-4 mt-3 footer-bottom-sec">
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex flex-nowrap align-items-center justify-content-between cus-copy-right">
                <div class="d-flex flex-row align-items-center">
                    ...
                    <ul class="d-flex flex-row ms-4 mb-0 p-0 list-group">
                        ...
                        <li class="nav-item m-0">
                            <a class="nav-link text-white" href="#">Cookie Policy</a>
                        </li>
                    </ul>
                </div>
                <ul class="list-unstyled m-0 d-flex align-items-center cus-social-media">
                    <li class="mb-0">
