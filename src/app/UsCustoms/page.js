        ...
        <div className="row">
            <div className="col-md-12">
                <div className="w-100 h-100 position-relative">
                    <img className="w-100 img-fluid cover" src="/images/hero-US-CUSTOMS.jpg" alt="" />
                    <h1 className="w-100 m-0 text-center text-uppercase position-absolute top-50 start-50 translate-middle text-white">U.S CUSTOMS</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="row">
                <div className="col-md-11 mx-auto pt-5">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 px-5">
                            <img className="w-100 img-fluid cover" src="/images/efficient-cross-border.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row">
                ...
                <div className="col-md-4 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">Timely Deliveries</h4>
                        <p className="text-white mb-0">Our customs expertise expedites the customs clearance process, reducing the risk of border delays.</p>
                    </div>
                </div>
                <div className="col-md-4 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">Compliance Assurance</h4>
                        <p className="text-white mb-0">We ensure your goods meet all regulatory requirements, reducing the risk of penalties and fines.</p>
                    </div>
                </div>
                <div className="col-md-4 my-3">
                    <div className="w-100 h-100 p-5 bg-secondary-dark">
                        ...
                        <h4 className="text-white text-uppercase my-4">Cost Efficiency</h4>
                        <p className="text-white mb-0">Our duty optimization strategies help minimize duty and tax expenses, boosting your cost-effectiveness.</p>
                    </div>
                </div>
            </div>
        </div>
